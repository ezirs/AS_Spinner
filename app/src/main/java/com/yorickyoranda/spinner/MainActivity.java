package com.yorickyoranda.spinner;
...
public class MainActivity extends AppCompatActivity {
    protected Spinner _spinner1, _spinner2, _spinner3, _spinner4, _spinner5;
    ...
    private void initSpinner5() {
        ...
        for (int number = 2; number <= 1000; number++) {
            if (isPrime(number)) {
                primeNumbers.add("Bilangan prima " + number);
            }
        }

        ArrayAdapter<String> arrayAdapter5 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, primeNumbers);
